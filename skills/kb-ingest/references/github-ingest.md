...
Represent each GitHub repository with one source markdown record under `knowledge-base/raw/github/`.

## Required Output

The raw-source record must include:
...
5. Create `knowledge-base/raw/github/owner-repo.md`.
...
After the standard raw-source record sections, add any useful GitHub-specific sections:
